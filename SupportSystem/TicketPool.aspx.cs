    ...
    public partial class TicketPool : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach(var Ticket in ticketList)
            {
                ...
                if (Ticket.UrgencyLevel == "High")
                {
                    phTicketsHigh.Controls.Add(new LiteralControl("<div class='col s12 m4'><div class='card-panel " + colour + "'>"));
                    ...
                    phTicketsHigh.Controls.Add(new LiteralControl("<span class='white-text'>" + Ticket.Body + "</span></div></div>"));
                }
                if (Ticket.UrgencyLevel == "Medium")
                {
                    phTicketsMedium.Controls.Add(new LiteralControl("<div class='col s12 m4'><div class='card-panel " + colour + "'>"));
                    ...
                    phTicketsMedium.Controls.Add(new LiteralControl("<span class='white-text'>" + Ticket.Body + "</span></div></div>"));
                }
                if (Ticket.UrgencyLevel == "Low")
                {
                    phTicketsLow.Controls.Add(new LiteralControl("<div class='col s12 m4'><div class='card-panel " + colour + "'>"));
                    phTicketsLow.Controls.Add(new LiteralControl("<span class='white-text' style='font-weight:bold;'>" + Ticket.UrgencyLevel + "</span><br><br>"));
                    phTicketsLow.Controls.Add(new LiteralControl("<span class='white-text'>" + Ticket.Body + "</span></div></div>"));
                }
            }
        }
    }
